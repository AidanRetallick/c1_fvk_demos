 ...
 for(unsigned e=0;e<n_b_element;e++)
  {
   ...
   ELEMENT* el_pt =
    dynamic_cast<ELEMENT*>(Bulk_mesh_pt->boundary_element_pt(Circular_arc_bnum,e));
   ...
   for(unsigned e=0; e<n_element; e++)
    {
     ...
     for (unsigned n=0; n<nnode;++n)
      {
       // Rotate nodes if on boundary b [zdec] David used this but it results in
       // boundary-adjacent elements at corners being mis-rotated
